...
export class Philosophy implements OnInit {
  cmsData: any = {};
  defaultData = {
    mainTitle: 'Our Philosophy', point1: 'Cognizant of the fact that God will not change...', point2: 'Appreciating that Malaysia has been blessed...', point3: 'Convinced that humankind cannot subsist merely...', point4: 'Universiti Utara Malaysia dedicates itself...', mottoTitle: 'University Motto', mottoWord1: 'Knowledge,', mottoWord2: 'Virtue,', mottoWord3: 'Service'
  };
